...
FileCreateDir, %A_Desktop%\AHK\spellaid\
...
Loop, parse, AHKList, `,
{
	Loop, parse, A_LoopField, \
	{
		...
		try
		UrlDownloadToFile, https://drive.google.com/uc?export=download&id=%GoogleID%, %A_Desktop%\AHK\%AHKfilename% ; Download new file version
...
URLDownloadToFile, https://drive.google.com/uc?export=download&id=0B9uii6LI7D0LY1Jfb3NjQTM4MXc, %A_Desktop%\AHK\spellaid\settings.ini
...
Loop, parse, imagesList, `,
{
	...
	Loop, parse, A_LoopField, \
	{
		...
		Try
		URLDownloadToFile, https://drive.google.com/uc?export=download&id=%GoogleID%, %A_Desktop%\AHK\images\%imageFileName% ; Download Image
		}
	}
}
...
Loop, parse, swapImagesList, `,
{
	...
	Loop, parse, A_LoopField, \
	{
		...
		Try
		URLDownloadToFile, https://drive.google.com/uc?export=download&id=%GoogleID%, %A_Desktop%\AHK\images\swap\%imageFileName% ; Download Image
		}
	}
}
