...
Menu, Tray, Add ,,
Menu, Tray, Add , Update Now, UpdateNow
Menu, Tray, Add ,,
...
IfWinNotExist, %A_scriptdir%\monitor.ahk
{
...
IfWinNotExist, %A_scriptdir%\spellaid.ahk
{
	if (skill != "ERROR") || (showName != "ERROR") || (showNick != "ERROR") || (showEmail != "ERROR")
...
{
IfWinExist, %A_ScriptDir%\spellaid.ahk
WinKill, %A_ScriptDir%\spellaid.ahk
...
IfWinExist, %A_ScriptDir%\updater.ahk
WinKill, %A_ScriptDir%\updater.ahk
...
clipboard=
(
Thank you for placing your Custom Creations order with us for your customized art design. We’re excited to see what the artists create for you to bring your idea to life! Below are the details of your order: 


STARTER, ENHANCED, DELUXE PACKAGE PURCHASED or MULTI-PACKAGE ($COSTTHEYPAID)

Your package includes #OFFREEREVISIONS based on your tier
...
How did you hear about CustomInk?
)
clipwait
send ^v
sleep 333
