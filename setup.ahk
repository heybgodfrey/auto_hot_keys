...
Gui, theSkill:Add, DropDownList, x222 y270 w175 h250 vSkill, Select One||Advanced|Core|Flex|Service|Lead
...
Gui, theChoice:Add, Button, center ym-10 x400 y430 w140 h30 Default gCustomHotkeys, Continue
...
Gui, theSettings:Add, Picture, w140 h-1 vUpdate gUpdateNow, %A_ScriptDir%\images\update.jpg
...
;if (startUp = "yes")
;{
;Gui, theSettings:Add, Picture, w117 h-1 vOff1 gtarget1Off, %A_ScriptDir%\images\off.jpg
;}
;else
;{
;Gui, theSettings:Add, Picture, w117 h-1 vOn1 gtarget1On, %A_ScriptDir%\images\on.jpg
;}
...
;Gui, theSettings:Add, Text, w300 CGray vtargetText1, Auto start AHK and other programs upon restart
...
if ((showTarget = "same") || (showTarget = "ERROR"))
{
GuiControl, theSettings:Move, Off, x425 y195
}
else if (showTarget = "new")
{
GuiControl, theSettings:Move, On, x425 y195
}

if ((showTarget = "same") || (showTarget = "ERROR"))
{
GuiControl, theSettings:Move, Off1, x425 y275
}
else if (showTarget = "new")
{
GuiControl, theSettings:Move, On1, x425 y275
}

GuiControl, theSettings:Move, targetText, x85 y205
GuiControl, theSettings:Move, targetText1, x85 y285
...
GuiControl, theSettings:Move, Update, x225 y380
...
UpdateNow:
TrayTip, Your scripts are now being updated,This process typically takes 30 seconds or less for the update to complete. You can continue to work while these files are updated. The setup menu will now close., 5000
sleep 5000
...
StringReplace, NewGeneralClosing, NewGeneralClosing, `%, ```%, All
...
CHReporting(NewUserHotkeyCommand,NewUserHotkeyText,theCustFilename)
...
Gui, theCustomChat:Add, Text, center CGray x175 y+20 w250 gAltD, Discounts
Gui, theCustomChat:Add, Text, center CGray x175 y+20 w250 gAltG, Group Order Form
Gui, theCustomChat:Add, Text, center CGray x175 y+20 w250 gAltZ, International
Gui, theCustomChat:Add, Text, center CGray x175 y+20 w250 gAltC, No Communication
...
StringReplace, NewAltN, NewAltN, `%, ```%, All
...
StringReplace, NewAltI, NewAltI, `%, ```%, All
...
StringReplace, NewAltH, NewAltH, `%, ```%, All
...
StringReplace, NewAltS, NewAltS, `%, ```%, All
...
StringReplace, NewAltX, NewAltX, `%, ```%, All
...
Gui, theAltD:Add, Picture, w140 h-1 vGoBack gCustomChat, %A_ScriptDir%\images\go_back.jpg
...
StringReplace, NewAltD, NewAltD, `%, ```%, All
...
Gui, theAltG:Add, Picture, w140 h-1 vGoBack gCustomChat, %A_ScriptDir%\images\go_back.jpg
...
StringReplace, NewAltG, NewAltG, `%, ```%, All
...
Gui, theAltZ:Add, Picture, w140 h-1 vGoBack gCustomChat, %A_ScriptDir%\images\go_back.jpg
...
StringReplace, NewAltZ, NewAltZ, `%, ```%, All
...
Gui, theAltC:Add, Picture, w140 h-1 vGoBack gCustomChat, %A_ScriptDir%\images\go_back.jpg
...
StringReplace, NewAltC, NewAltC, `%, ```%, All
...
StringReplace, NewAltB, NewAltB, `%, ```%, All
...
Gui, theSpellingList:Show, x%Xpos% y%Ypos% h%height% w%GuiWidth%, Spelling List (1 of 3)
...
IniRead, toggle30, %spellini%, spellaid30, KEY1
...
Gui, theSpellingList2:Add, Picture, w140 h-1 vNext gSpellingList3, %A_ScriptDir%\images\next.jpg
...
Gui, theSpellingList2:Add, Checkbox, v17on Checked%toggle17%, On
Gui, theSpellingList2:Add, Checkbox, v18on Checked%toggle18%, On
Gui, theSpellingList2:Add, Checkbox, v19on Checked%toggle19%, On
...
GuiControl, theSpellingList2:Move, Next, x380 y430


GuiControl, theSpellingList2:Move, 15on, x365 y330
GuiControl, theSpellingList2:Move, 15word, x410 y325

GuiControl, theSpellingList2:Move, 16on, x365 y360
GuiControl, theSpellingList2:Move, 16word, x410 y355
...
GuiControl, theSpellingList2:Move, 24on, x365 y300
GuiControl, theSpellingList2:Move, 24word, x410 y295
...
Gui, theSpellingList2:Show, x%Xpos% y%Ypos% h%height% w%GuiWidth%, Spelling List (2 of 3)
...
IniRead, toggle29, %spellini%, spellaid29, KEY1
IniRead, toggle30, %spellini%, spellaid30, KEY1
IniRead, toggle31, %spellini%, spellaid31, KEY1
IniRead, toggle32, %spellini%, spellaid32, KEY1

Gui, theSpellingList3:Add, Picture, w180 h-1 vLogo gLogo, %A_ScriptDir%\images\ahk_manual.jpg
Gui, theSpellingList3:Add, Picture, w140 h-1 vGoBack gSpellingList2, %A_ScriptDir%\images\go_back.jpg
Gui, theSpellingList3:Add, Picture, w140 h-1 vSave gSpellingProcess3, %A_ScriptDir%\images\save.jpg

Gui, theSpellingList3:Color, FFFFFF
Gui, theSpellingList3:Font, S26, w700
Gui, theSpellingList3:Add, Text, center CGray x20 y119 w550, AutoCorrect Spelling List
Gui, theSpellingList3:Font, S10, w700

Gui, theSpellingList3:Add, Checkbox, v29on Checked%toggle29%, On
Gui, theSpellingList3:Add, Checkbox, v30on Checked%toggle30%, On
Gui, theSpellingList3:Add, Checkbox, v31on Checked%toggle31%, On
Gui, theSpellingList3:Add, Checkbox, v32on Checked%toggle32%, On


Gui, theSpellingList3:Font, S14, bold
Gui, theSpellingList3:Add, Text, CBlue v29word, underneath
Gui, theSpellingList3:Add, Text, CBlue v30word, you're
Gui, theSpellingList3:Add, Text, CBlue v31word, shirt
Gui, theSpellingList3:Add, Text, CBlue v32word, unavailable



GuiControl, theSpellingList3:Move, Logo, x210
GuiControl, theSpellingList3:Move, Save, x230 y430
GuiControl, theSpellingList3:Move, GoBack, x80 y430


GuiControl, theSpellingList3:Move, 29on, x85 y180
GuiControl, theSpellingList3:Move, 29word, x130 y175

GuiControl, theSpellingList3:Move, 30on, x365 y180
GuiControl, theSpellingList3:Move, 30word, x410 y175

GuiControl, theSpellingList3:Move, 31on, x85 y210
GuiControl, theSpellingList3:Move, 31word, x130 y205

GuiControl, theSpellingList3:Move, 32on, x365 y210
GuiControl, theSpellingList3:Move, 32word, x410 y205


Gui, theSpellingList3:Font, S10, w700
Gui, theSpellingList3:Add, Text, center y475 w570 x20 vFeedback gFeedback, Feedback
Gui, theSpellingList3:Show, x%Xpos% y%Ypos% h%height% w%GuiWidth%, Spelling List (3 of 3)
...
if (30on = 1)
{
IniWrite, 1, %ini%, spellaid30, KEY1
}
else
{
IniWrite, 0, %ini%, spellaid30, KEY1
}

if (31on = 1)
{
IniWrite, 1, %ini%, spellaid31, KEY1
}
else
{
IniWrite, 0, %ini%, spellaid31, KEY1
}

if (32on = 1)
{
IniWrite, 1, %ini%, spellaid32, KEY1
}
else
{
IniWrite, 0, %ini%, spellaid32, KEY1
}
...
theSpellingList3GuiClose:
ExitApp

GuiClose:
ExitApp

CHReporting(keyname,keytext,slot)
{
INI=%A_scriptdir%\reports\CHreport.ini
fileINI = %A_ScriptDir%\reports\
...
IfNotExist, %fileINI%
   ...
   IniWrite, %keyname%, %ini%, %slot%, Command
   IniWrite, %keytext%, %ini%, %slot%, Text
   IniWrite, 0, %ini%, %slot%, Total
}
